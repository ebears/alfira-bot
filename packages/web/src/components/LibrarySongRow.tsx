...
export const LibrarySongRow = memo(
  ({
    ...
    return (
      <div className="flex flex-col rounded-lg bg-elevated clay-resting hover:clay-raised hover:-translate-y-px active:clay-flat active:translate-y-0 transition-all duration-100" data-song-edit-container>
        <div
