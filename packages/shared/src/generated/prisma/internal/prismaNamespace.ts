...
> = {
  ...
  meta: {
    modelProps: 'song' | 'playlist' | 'playlistSong' | 'refreshToken';
    ...
    PlaylistSong: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.PlaylistSongCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type PlaylistSongScalarFieldEnum =
  (typeof PlaylistSongScalarFieldEnum)[keyof typeof PlaylistSongScalarFieldEnum];
